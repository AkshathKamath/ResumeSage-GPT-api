...
def improve_resume(resume_text):
    summary_response = client.chat.completions.create(
        ...
        messages = [
            ...
            {
                "role":"user",
                "content":f"Suggest improvements on this resume: {resume_text}. Kepp the improvements strictly structural in nature. Just provide the improvements nothing more. Provide them as a numbered list without any headings."
            }
        ]
    )
...
# print(improve_resume(resume_text))